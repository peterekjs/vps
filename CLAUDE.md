...
When adding a new setup script, follow the same pattern: number prefix, source `common.sh`, use the helpers rather than reinventing logging/backup/install logic.
